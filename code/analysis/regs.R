...
etable(TC.1,TC.2,TC.3,T1C.4, keep = "d_black", tex=TRUE, digits=3, replace=TRUE,
       file = paste0(cdir,"/empirics/results/black-white/tables/gap_yearspecific_car.tex") )
...
etable(T1B.6,T1C.4,T1C.bus,T1C.subway,T1C.walk,keep = "d_black", tex=TRUE, digits=3, replace=TRUE,
       file = paste0(cdir,"/empirics/results/black-white/tables/gap_yearspecific_modcomps.tex") )
...
etable(T8.all,T8.car,T8.bus,T8.subway,T8.walk,
       ...
       file = paste0(cdir,"/empirics/results/black-white/tables/gap_yearspecific_citygroups.tex") )
...
etable(P.all,P.car,P.bus,P.subway,P.walk,keep = "d_black", tex=TRUE, digits=3, replace=TRUE,
       file = paste0(cdir,"/empirics/results/black-white/tables/gap_yearspecificpumas_modcomps.tex") )
...
etable(P8.all,P8.car,P8.bus,P8.subway,P8.walk,
       ...
       keep = "d_black", tex=TRUE, digits=3, replace=TRUE,
       file = paste0(cdir,"/empirics/results/black-white/tables/gap_yearspecificpumas_citygroups.tex") )
