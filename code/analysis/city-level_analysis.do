...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_commuting_nocontrol.tex", ///
	b(4) se(4) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_commuting_nocontrol.csv", ///
	b(4) se(4) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
est clear
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_commuting_wcontrol.tex", ///
	b(4) se(4) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_commuting_wcontrol.csv", ///
	b(4) se(4) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
est clear
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_segregation_nocontrol.tex", ///
	b(4) se(4) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_segregation_nocontrol.csv", ///
	b(4) se(4) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
est clear
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_segregation_wcontrol.tex", ///
	b(4) se(4) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_segregation_wcontrol.csv", ///
	b(4) se(4) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
est clear
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_urbanform_nocontrol.tex", ///
	b(4) se(4) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_urbanform_nocontrol.csv", ///
	b(4) se(4) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
est clear
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_urbanform_wcontrol.tex", ///
	b(4) se(4) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_urbanform_wcontrol.csv", ///
	b(4) se(4) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
est clear
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_hpsort_nocontrol.tex", ///
	b(4) se(4) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_hpsort_nocontrol.csv", ///
	b(4) se(4) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
est clear
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_hpsort_wcontrol.tex", ///
	b(4) se(4) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_hpsort_wcontrol.csv", ///
	b(4) se(4) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
est clear
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_panel_housing.tex", ///
	b(4) se(4) nocon mlabels(,titles) replace bookt f legend r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_panel_housing.csv", ///
	b(4) se(4) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
...
foreach y of numlist 1980 1990 2000 2010 2019 {
	...
	esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_xsec_all_`y'.tex", ///
		rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
	esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_xsec_all_`y'.csv", ///
		rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
...
foreach y of numlist 1980 1990 2000 2010 2019 {
	...
	esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_xsec_short_`y'.tex", ///
		rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
	esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_xsec_short_`y'.csv", ///
		rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
...
foreach y of numlist 1980 1990 2000 2010 2019 {
	...
	esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_xsec_shortpop_`y'.tex", ///
		rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace bookt f r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend drop(lpop)
	esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_xsec_shortpop_`y'.csv", ///
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_panel_all.tex", ///
	rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace bookt f legend r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_panel_all.csv", ///
	rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_panel_short.tex", ///
	rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace bookt f legend r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_panel_short.csv", ///
	rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
...
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_panel_shortpop.tex", ///
	rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace bookt f legend r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
esttab using "${DGIT}/results/${SAMPLE}/tables/citylevel_regs_panel_shortpop.csv", ///
	rename(`explvar') b(3) se(3) nocon mlabels(,titles) replace csv r2(3) starlevels(+ 0.10 * 0.05 ** 0.01 *** 0.001) legend
